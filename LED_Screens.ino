...
void loop() {
 ...
 int f3p[] = {};
 int f3r[] = {};
 int f3pSize = sizeof(f3p);
 int f3rSize - sizeof(f3r);

 for(i = 0, i < f3pSize+1; i++){
    leds[f3p[i]] = CRGB::Purple;
 }
 i=0;
 for(i = 0, i < f3rSize+1; i++){
    leds[f3r[i]] = CRGB::Red;
 }
 FastLED.show();
 delay(150000);
